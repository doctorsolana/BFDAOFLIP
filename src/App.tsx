...
function Flip() {
  ...
  return (
    <>
      <Canvas linear flat onContextMenu={(e) => e.preventDefault()} style={{
          backgroundImage: 'url(https://i.imgur.com/boJ6gCV.png)',
          backgroundSize: 'cover', // this will make sure the image covers the entire component
